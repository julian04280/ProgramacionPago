...
public class Programar {
	...
	private static final String PAGO_ASIGNADO_SIGUIENTE_DIA_HABIL = "El pago se programa para el siguiente día habil.";
	private static final String PAGO_FESTIVO = "El costo de transacción es del doble por ser festivo";
