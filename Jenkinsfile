pipeline {
  ...
  tools {
    jdk 'JDK11_Centos' //Preinstalada en la ConfiguraciÃ³n del Master
  ...
  post {
    ...
    failure {
      ...
      mail (to: 'julian.diaz@ceiba.com.co',subject: "Failed Pipeline:${currentBuild.fullDisplayName}",body: "Something is wrong with ${env.BUILD_URL}")
    }
    unstable {
